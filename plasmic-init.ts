...
PLASMIC.registerComponent(MainSidebar, {
  ...
  props: {
    ...
    signInHref: { type: "string", description: "Sign-in link", defaultValue: "/login" },
    bgColor: { type: "string", description: "Sidebar background color (hex/rgba)", defaultValue: "#391709" },
    textColor: { type: "string", description: "Text color (hex/rgba)", defaultValue: "white" },
    activeBgColor: { type: "string", description: "Active item background (hex/rgba)", defaultValue: "rgba(255, 255, 255, 0.15)" },
    hoverBgColor: { type: "string", description: "Hover background (hex/rgba)", defaultValue: "rgba(255, 255, 255, 0.1)" },
...
PLASMIC.registerComponent(PageShellShadcn, {
  ...
  props: {
    ...
    signInLabel: { type: "string", description: "Sign in button text", defaultValue: "Sign In" },
    signInHref: { type: "string", description: "Sign-in link", defaultValue: "/login" },
    sidebarBgColor: { type: "string", description: "Sidebar background color (hex/rgba)", defaultValue: "#391709" },
    sidebarTextColor: { type: "string", description: "Sidebar text color (hex/rgba)", defaultValue: "white" },
    sidebarActiveBgColor: { type: "string", description: "Active item background (hex/rgba)", defaultValue: "rgba(255, 255, 255, 0.15)" },
