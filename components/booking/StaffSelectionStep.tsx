  ...
  return (
    <div className="service-selection-container">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-3">Choose Your Stylist</h2>
        <p className="text-lg font-medium">Select your preferred stylist or let us choose the best available</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card className="text-center p-3 bg-white rounded-xl border border-gray-200 flex flex-col items-center justify-center">
          ...
          {!showGuestInput ? (
            <div className="flex flex-col items-center">
              ...
              <Button
                size="sm"
                className="bg-orange-primary hover:bg-orange-primary text-white mt-2"
        ...
        <Card className="hidden md:block text-center p-3 bg-white rounded-xl border border-gray-200 flex flex-col items-center justify-center">
          <div className="font-bold text-lg mb-1 text-black">Stylist</div>
          <div className="text-orange-primary font-semibold text-center">{selectedStaffObj?.name || 'Any available'}</div>
        </Card>
      </div>
